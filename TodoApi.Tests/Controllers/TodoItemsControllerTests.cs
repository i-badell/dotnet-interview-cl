...
public class TodoItemsControllerTests
{
    ...
    private void PopulateDatabaseContext(TodoContext context)
    {
        ...
        list1.TodoItems.Add(new TodoItem { Id = 1, Title = "Task 1", Description = "Description 1", Completed = false, TodoListId = 1 });
        list1.TodoItems.Add(new TodoItem { Id = 2, Title = "Task 2", Description = "Description 2", Completed = false, TodoListId = 1 });

        // Another list to verify scoping by listId
        var list2 = new TodoList { Id = 2, Name = "Task list 2" };
        list2.TodoItems.Add(new TodoItem { Id = 3, Title = "Other list item", Description = "Desc", Completed = true, TodoListId = 2 });
    ...
    public async Task PutTodoItem_WhenListDoesNotExist_ReturnsNotFound()
    {
        ...
        var payload = new UpdateTodoItem { Title = "X", Description = "Y", Completed = false };
    ...
    public async Task PostTodoItem_WhenListDoesNotExist_ReturnsNotFound()
    {
        ...
        var payload = new CreateTodoItem { Title = "X", Description = "Y", Completed = false };
